...
#define LED_PIN D0 // The ESP8266 pin D5 connected to resistor
#define FAN_PIN D1
#define AC_PIN D3
...
const char WIFI_SSID[] = "Arthur Morgan";     // CHANGE TO YOUR WIFI SSID
const char WIFI_PASSWORD[] = "0985696201";  // CHANGE TO YOUR WIFI PASSWORD

const char MQTT_BROKER_ADRRESS[] = "192.168.1.6";  // CHANGE TO MQTT BROKER'S ADDRESS
const int MQTT_PORT = 1883;
const char MQTT_CLIENT_ID[] = "nlqkl";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "mqtt";                        // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "nguyenlequockhanh";                        // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that ESP8266 should publish/subscribe
const char PUBLISH_TOPIC[] = "datasensor";    // CHANGE IT AS YOU DESIRE

const int PUBLISH_INTERVAL = 8000;  // 5 seconds
